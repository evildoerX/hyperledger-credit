...
用户 --> (业务公司法务)
(业务公司法务) ..> (添加业务员到黑名单): <<include>>
(业务公司法务) ..> (提交黑平单给上层机构审核): <<include>>
用户 --> (业务员)
(业务员) ..> (查看业务员个人服务评价信息): <<include>>
(业务员) ..> (上传业务员职业资格证): <<include>>
(业务员) ..> (提交业务员申诉): <<include>>
(业务员) ..> (支付上岗证费用): <<include>>
用户 --> (平台管理员)
(平台管理员) ..> (链码管理): <<include>>
(平台管理员) ..> (链机构管理): <<include>>
用户 --> (普通用户)
(普通用户) ..> (查看业务员上岗证): <<include>>
(普通用户) ..> (评价业务员服务): <<include>>
@enduml
